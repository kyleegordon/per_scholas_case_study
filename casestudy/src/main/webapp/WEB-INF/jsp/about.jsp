    ...
    <div class="main__container">
        <div class="main__content">
            ...
            <p class="form_table" style="font-size: 1.5rem; font-weight: normal; line-height: 1.8rem;">
                ...
                multiple locations, we will effectively meet your needs to provide a right sized security solution.
            </p>
        </div>
        <div class="main__img--container">
            <img src="../../../pub/images/undraw_security_on_re_e491 (1).svg" alt="surveillance image" id="main__img">
        </div>
    </div>
</div>
